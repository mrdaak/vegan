...
const CSS = {
  ...
  folder:
    ".db.ba.b--black-10.w5.black.bg-light-yellow.pa2.mr3.shadow-4.br1.overflow-x-auto",
  folderHeader: ".db.flex.justify-between",
  folderTitle: ".w-90.med-gray.f4",
  folderCardsWrapper: ".db.w-100",
  folderCard:
    "a.db.ba.b--black-10.bg-washed-yellow.mv1.pa2.link.black.hide-child",
  ...
  inputField:
    "input[type=text].input-reset.bn.pa2.mb2.db.w-90.bg-light-yellow.f4",
  createFolderButton:
